data "template_file" "appserver_container_definitions" {
  ...
  vars = {
    ...
    database_name = module.db_old.cluster_database_name
    database_username = module.db_old.cluster_master_username
    database_host = module.db_old.cluster_endpoint
    database_port = module.db_old.cluster_port
    db_pool = var.db_pool
