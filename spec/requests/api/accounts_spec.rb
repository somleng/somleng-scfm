...
RSpec.describe "Accounts" do
  include Docs::Accounts::Api

  let(:account) { create(:account, :super_admin) }
  let(:access_token) { create_access_token(resource_owner: account) }

  describe "#index" do
    include Docs::Accounts::Index

    it "returns a list of accounts filtered by metadata", :dox do
  ...
  describe "#create" do
    include Docs::Accounts::Create

    it "creates an account", :dox do
      post(
        api_accounts_path,
        headers: build_authorization_headers(access_token: access_token)
      )
  ...
  describe "#show" do
    include Docs::Accounts::Show

    it "fetches an account", :dox do
  ...
  describe "#update" do
    include Docs::Accounts::Update

    it "can update an account", :dox do
  ...
  describe "#destroy" do
    include Docs::Accounts::Destroy

    it "can delete an account", :dox do
      other_account = create(:account)
